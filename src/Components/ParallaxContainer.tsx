...
const ParallaxContainer = () => {
  ...
  let textPrxHeader1 = (
    <FormattedMessage id="prx-container-header1" defaultMessage="Feature1" />
  );
  let textPrxHeader2 = (
    <FormattedMessage id="prx-container-header2" defaultMessage="Feature1" />
  );
  let textPrxButton = (
    <FormattedMessage id="prx-container-button" defaultMessage="Feature1" />
  );
  ...
  let textPrxButtonGetStarted = (
    <FormattedMessage
      id="prx-container-button-getstarted"
      defaultMessage="Feature1"
    />
  );
  let textPrxButtonGetInTouch = (
    <FormattedMessage
      id="prx-container-button-getintouch"
      defaultMessage="Feature1"
    />
  );
    ...
    <div className="container-fluid mx-0 px-0 position-relative">
      ...
      <ParallaxProvider>
        ...
        <div className="d-block containerStyle position-relative">
          <Parallax y={[0, -55]}>
            <img style={styles.imageStyle} src={image} alt="" />
          </Parallax>
        ...
        <Row className="d-flex flex-wrap">
          ...
          <Col className="d-flex col-12 col-lg-4 justify-content-center align-self-center">
            <div className="d-flex py-3 justify-content-center mx-auto">
              <Button
                className="mx-2 px-4 py-3 my-1 buttonAccent"
                variant="accent"
              >
                {textPrxButtonGetStarted}
              </Button>
              <Button
                className="mx-2 px-4 py-3 my-1 buttonGray"
                variant="accent"
              >
                {textPrxButtonGetInTouch}
              </Button>
            </div>
          </Col>
        </Row>
