...
const Cards2 = (props: CardsProps) => {
  ...
  let textCardTitle1 = (
    <FormattedMessage id="card-2-1-title" defaultMessage="Feature1" />
  );
  let textCard1 = (
    <FormattedMessage id="card-2-1-text1" defaultMessage="Feature1" />
  );
  let textCardTitle2 = (
    <FormattedMessage id="card-2-2-title" defaultMessage="Feature1" />
  );
  let textCard2 = (
    <FormattedMessage id="card-2-2-text1" defaultMessage="Feature1" />
  );
